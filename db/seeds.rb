...
10.times do |i|
  Product.create(name: "Plave tene za žene", price: 100, description: "Udobna obuća za djevojke i žene.", category_id: 1, sale: 80, special: 0)
  Product.create(name: "Udobne štikle", price: 10, description: "Udobne štikle za lagano hodanje.", category_id: 1, sale: '', special: 1)
  Product.create(name: "Crne čizme", price: 190, description: "Čizme za proljeće. Dostupne u tri boje.", category_id: 1, sale: 150, special: 0)
  Product.create(name: "Crne zimske čizme", price: 80, description: "Čizme idealne za zimske dane.", category_id: 1, sale: '', special: 1)
  Product.create(name: "Gležnjače", price: 50, description: "Idealna obuća za jeden. Dostupne u dvije boje.", category_id: 1, sale: '', special: 0)
end
