...
hp1 = HelpProduct.create(size: "36", quantity: 100, p1.id)
hp2 = HelpProduct.create(size: "37", quantity: 100, p1.id)
hp3 = HelpProduct.create(size: "38", quantity: 100, p1.id)
hp4 = HelpProduct.create(size: "37", quantity: 100, p2.id)
hp5 = HelpProduct.create(size: "37", quantity: 100, p3.id)
hp6 = HelpProduct.create(size: "38", quantity: 100, p4.id)
hp7 = HelpProduct.create(size: "37", quantity: 100, p5.id)
hp8 = HelpProduct.create(size: "40", quantity: 100, p5.id)


i1 = Image.create(p1.id, main: '1')
i2 = Image.create(p1.id, main: nil)
i3 = Image.create(p2.id, main: '1')
i4 = Image.create(p3.id, main: '1')
i5 = Image.create(p3.id, main: nil)
i6 = Image.create(p4.id, main: '1')
i7 = Image.create(p5.id, main: '1')
i8 = Image.create(p5.id, main: nil)
i9 = Image.create(p6.id, main: nil)
i10 = Image.create(p5.id, main: nil)
